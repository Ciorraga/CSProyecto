...
$app->get('/clas_eq', function() use ($app) {
    ...
    $app->render('clasificacionEquipos.html.twig',array('imagenUser'=>$_SESSION['usuarioLogin']['imagen'],'usuarioLogin'=>$_SESSION['usuarioLogin'],'numMensajes' => $_SESSION['numMensajes'],'nuevaSolicitud' => $_SESSION['solicitudes'],'clasificacion' => $clasRetos,'esCapitan' => $esCapitan));
});