...
$app->get('/retos', function() use ($app) {
    ...
    $app->render('retos.html.twig',array('imagenUser'=>$_SESSION['usuarioLogin']['imagen'],'usuarioLogin'=>$_SESSION['usuarioLogin'],'numMensajes' => $_SESSION['numMensajes'],'nuevaSolicitud' => $_SESSION['solicitudes'],'clasificacion' => $clasRetos,'ultimosJugados' => $ultJugados,'pendientes' => $pendientes,'esCapitan' => $esCapitan));
})->name('retos');